jQuery(document).ready(function () {
    ...
    *****************************************/
    jQuery(document).on("click", ".product_varient_update", function () {
        ...
        if(jQuery(".product-variant-body input:checked").length == selected_product_variants.length){
    ...
    jQuery(document).on("click", ".product_variant_picker_model_save", function () {
        ...
        // if(jQuery(".product-variant-body input:checked").length === selected_products.length){
        //     jQuery("#trigger_variant_selectall").prop("checked", true);
        // } 
...
function load_discount_type(call_type) {
    ...
    console.log("load_discount_type call_type -------", call_type);
    console.log("load_discount_type discount_type -------", discount_type);
...
function load_shopify_product_modal() {
    ...
    console.log("load_shopify_product_modal action_type------", action_type);

    let trigger_product_ids = [];
    if (action_type === "customer_discount_product_items") {
        trigger_product_ids = jQuery('.customer_discount_product_item').map(function () {
...
function load_shopify_collection_modal() {
    ...
    if (action_type === "customer_discount_collection_items") {
        trigger_collection_ids = jQuery('.customer_discount_collection_item').map(function () {
            return jQuery(this).attr('product_id');
        }).get();
    }
