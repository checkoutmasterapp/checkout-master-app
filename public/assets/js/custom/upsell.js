    ...
    *****************************************/
    ...
    jQuery(".upsell_offer_sortable").sortable({
        ...
        stop: function (event, ui) {
            ...
            console.log("upsell_offer_sortable upsell_trigger_offers-----------", upsell_trigger_offers);
    ...
    jQuery(document).on("click", ".upsell_offer_variants_update", function (target, event) {
        ...
        jQuery(".edit_upsell_variant_offer_body").html(`
            <div class="flex items-center px-4 space-x-5 offer_type">
            ...
            upsell_trigger_product_html += `
				...
				>
					...
					<div class="delete_one">
						<i
                            class="bi bi-trash upsell_trigger_delete"
        ...
        if (upsell_trigger_offer?.product_title) {
            ...
            upsell_offer_product_content_html = `
                <div
                    ...
                    class="flex items-center px-4 py-2 space-x-5 offer_type purchase_upsell_offers_product trigger_offer_${upsell_trigger_offer_key}"
                >
                    <div class="add_ima">
                        <div class="image-add">
                    ...
                    <div class="delete_one me-2">
                        <i
                            class="bi bi-pencil me-3 upsell_offer_variants_update"
                            product_id="${upsell_trigger_offer?.product_id}"
                        ...
                        ></i>
                        <i
                            class="bi bi-trash upsell_offer_product_delete"
                            product_id="${upsell_trigger_offer?.product_id}"
                            trigger_offer_key="${upsell_trigger_offer_key}"
                            upsell_trigger_offer_id="${upsell_trigger_offer?.id}"
                            upsell_trigger_offer_uuid="${upsell_trigger_offer?.upsell_trigger_offer_uuid}"
...
function get_performance_filter_records() {
    ...
    console.log("performance_start---------", performance_start);
    console.log("performance_end---------", performance_end);
...
function load_upsell_performance_section() {
    jQuery(".upsell_performance_section").html(`
        ...
        <div class="col-lg-3 col-md-6">
            <div class="data-prst persnt pt-4 px-3 pb-3">
                <h2 class="text-degin-prtisht">$${upsell_performance_record?.upsell_revenue?.toFixed(2)}</h2>
