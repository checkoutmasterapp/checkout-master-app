    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (process.env.PAYMENT_MODE !== "live") {
                payment_detail.processing_channel_id = checkout_processing_channel_id;
            }

            const payment = await cko.payments.request(payment_detail);
            console.log("CheckoutChargesCreate payment -----------------", payment);
...
module.exports.CheckoutUpsellPaymentCreate = async (request_body, parent_order_detail, callback) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            console.log("CheckoutUpsellPaymentCreate payment_detail--------", payment_detail);

            const checkout_payment = await cko.payments.request(payment_detail);
