...
const {
    Countries,
    UserSubscriptions,
    CustomizeAboutSections, CustomizeCheckout, Stores,
    ShippingRates, PaymentMethods, Translations, Taxes
} = require("../models");
...
module.exports.preview_checkout = async (req, res, next) => {
    ...
    let customize_checkout_publish = false;
    if (auth_store.customize_checkout_publish) {
        customize_checkout_publish = true;
    }
